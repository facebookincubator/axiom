...
TEST_F(PlanPrinterTest, specialForms) {
  ...
  EXPECT_THAT(
      ...
      testing::ElementsAre(
          ...
          testing::StartsWith("      expr_7 := case("),
  ...
  EXPECT_THAT(
      ...
      testing::ElementsAre(
          ...
          testing::Eq("        expressions: AND: 1, CAST: 6, COALESCE: 1, DEREFERENCE: 2, IF: 1, OR: 1, TRY: 1, TRY_CAST: 1, call: 9, constant: 11, field: 20"),
          testing::Eq("        functions: case: 1, divide: 2, gt: 4, lt: 1, multiply: 1"),
