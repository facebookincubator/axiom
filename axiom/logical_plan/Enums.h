...
// Code adapted from velox/common/Enums.h
...
/// } // namespace
///
/// VERAX_DEFINE_ENUM_NAME(Foo, fooNames);
///
...
#define VERAX_DECLARE_ENUM_NAME(EnumType)                                  \
...
#define VERAX_DEFINE_ENUM_NAME(EnumType, Names)                       \
  ...
  std::optional<EnumType> EnumType##Name::tryTo##EnumType(            \
    ...
    static const auto kValues =                                       \
        facebook::velox::logical_plan::Enums::invertMap(Names());     \
                                                                      \
...
#define VERAX_DECLARE_EMBEDDED_ENUM_NAME(EnumType)     \
  static std::string_view toName(EnumType value);      \
  static EnumType to##EnumType(std::string_view name); \
  static std::optional<EnumType> tryTo##EnumType(std::string_view name);

#define VERAX_DEFINE_EMBEDDED_ENUM_NAME(Class, EnumType, Names)       \
