...
class SqlQueryRunner {
 public:
  ...
  struct RunOptions {
    ...
    facebook::axiom::connector::ConnectorWriterProvider componentWriterProvider{
    ...
    facebook::axiom::connector::ConnectorWriterProvider connectorWriterProvider{
        facebook::axiom::connector::noopConnectorWriterProvider()};
  };
 ...
 private:
  ...
  makeOptimizerSession(
      ...
      facebook::axiom::connector::ConnectorWriterProvider
